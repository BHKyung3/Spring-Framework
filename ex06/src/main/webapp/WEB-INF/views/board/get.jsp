    ...
    <div class="col-lg-12">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                	...
                	<!-- 본인이 작성한 게시글에만 수정 버튼이 보이게 하는 부분 -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		$("#addReplyBtn").on("click", function(e){
			...
			modal.find("input[name='replyer']").val(replyer).attr("readonly", "readonly"); //댓글 작성자 자동입력(login한 사람ID)
		...
		//댓글 수정 이벤트 처리 -> 댓글의 작성자가 같이 전송되늰 방식
