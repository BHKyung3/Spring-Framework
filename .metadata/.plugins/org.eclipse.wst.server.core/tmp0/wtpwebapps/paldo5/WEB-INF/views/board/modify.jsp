  ...
  <form id="actionForm" action="" method="post" class="product-detail-container">
    ...
    <div class="product-images">
      <div class="main-image">
        <img src="<c:url value='${board.ImgPath.imgPath}'/>" alt="대표 이미지" />
      </div>
    ...
    <div class="product-info">
      <input type="hidden" name="pno" value="${board.boardid}" />
      ...
      <div class="brand">
        브랜드: <input type="text" name="brand" value="${board.product.brand}" class="form-control" />
      </div>

      <div class="nickname mt-2">
        판매자: <input type="text" name="nickname" value="${board.user.nickname}" class="form-control" />
      </div>
